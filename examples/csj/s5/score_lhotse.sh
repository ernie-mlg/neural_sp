...
model=/home/yyu/Repos/neural_sp_yang/examples/csj/s5/exp/asr/train_nodev_all_wpbpe10000/conv2Lblstm512H5L_sumfwdbwd_chunkL-1R40_drop4_lstm1024H1L_location_ss0.2_adam_lr0.001_bs40_ls0.1_ctc0.3/model.epoch-6
model1=
model2=
model3=
model_bwd=
...
stdout=false
n_threads=1
sclite=/opt/kaldi/tools/sctk-20159b5/src/sclite/sclite

### path to save preproecssed data
data=/home/yyu/Repos/neural_sp_yang/examples/csj/s5/data
...
#for set in dev eval1 eval2 eval3; do
